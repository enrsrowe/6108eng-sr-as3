		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (feed.description != 'Yahoo! Weather Error') {
					...
					// Add item data
					html += '<h4 class="weatherCity">'+ feed.location.city +'</h4>';
					...
					if (options.link) html += '<div class="weatherLink"><a href="'+ feed.link +'" target="'+ options.linktarget +'" class=" pull-right btn btn-small btn-success" style="margin-top:-30px;" title="Read full forecast">Full forecast</a></div>';
